...
const PricingHeader = () => {
  return (
    <section className="relative bg-[#F1F2FF] overflow-hidden pt-28 pb-12 md:pt-40  md:pb-20">
      <Image
        src={bannerbg}
        alt="curve"
      ...
      <Image
        src={ellipse}
        alt="curve"
        className=" xl:block absolute top-60 md:top-70 left-[1%] md:left-[10%] pointer-events-none z-0"
      />
        ...
        <div className="space-y-6">
         ...
         <div className="flex items-center gap-2 justify-center">
          ...
          <h1 className="display-xxl lg:display-xxxl sec-color font-bold leading-[1.05]">
           Simple Pricing for Your <br /> Design Needs
          </h1>

          <p className="body-m text-text-secondary max-w-200 mx-auto opacity-80">
